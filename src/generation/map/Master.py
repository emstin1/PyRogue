class Master:
    ...
    def __init__(self, current_room, room_type):
    ...
    def add_walker(self, pos):
        self.walkers.append(self.walker_type(self.current_room, pos))
